    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-slate-100 rounded-[2.5rem] p-8 border border-slate-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${queueTab === 'pending' ? 'text-blue-700' : 'text-slate-400'}`}>Submissions pending review</p>
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'pending' ? 'text-blue-600/90' : 'text-slate-500'}`}>Sales Department</p>
          ...
          >
            <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${queueTab === 'history' ? 'text-blue-700' : 'text-slate-400'}`}>Validated in Department</p>
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'history' ? 'text-blue-600/90' : 'text-slate-500'}`}>Sales Department</p>
            <div className="relative flex items-center justify-center w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgb(226 232 240)" strokeWidth="10" />
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className={`text-[9px] font-bold uppercase tracking-widest mt-1 ${queueTab === 'history' ? 'text-blue-600' : 'text-slate-400'}`}>validated</span>
              </div>
            </div>
          </button>
          <button
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'rejected' ? 'text-red-600/90' : 'text-slate-500'}`}>Sales Department</p>
            <div className="relative flex items-center justify-center w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgb(226 232 240)" strokeWidth="10" />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-[2rem] border border-slate-100">
        <div className="flex items-center gap-4">
          ...
          <div><h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Sales Registry</h3><p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{queueTab === 'pending' ? 'Pending Sales Review' : queueTab === 'history' ? 'Validated Sales Records' : 'Rejected Sales Records'}</p></div>
        </div>
        ...
        {searchFilteredQueue.length === 0 ? (
          <div className="py-20 text-center bg-white rounded-[2rem] border border-slate-50 border-dashed">
            ...
            <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">
              {searchTerm.trim() ? 'No records match your search' : 'No Sales records in this tab'}
            </p>
          </div>
        ) : (
            ...
            return (
              <div key={item.id} className="group flex items-center justify-between p-6 rounded-[2rem] border bg-white border-slate-50 hover:shadow-md transition-all">
                <div className="flex items-center gap-6">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center font-black bg-slate-100 text-slate-600">
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Sales Unit Matrix</h3>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Sales Personnel</th>
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-500">
        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
          <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-6">Sales Department — Last 30 Days</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
              <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest mb-1">Validated</p>
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden pb-12">
          <div className="p-10 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h3 className="text-xl font-black text-slate-900 tracking-tight">{isReadOnly ? (selectedItem.status === 'rejected' ? 'Rejected submission' : 'Archived submission') : 'Review submission'}</h3>
            ...
            {!isReadOnly && (
               <div className={`px-4 py-2 rounded-xl border text-[9px] font-black uppercase tracking-widest flex items-center gap-2 ${calculatedScore.incentivePct >= 1 ? 'bg-blue-50 text-blue-600 border-blue-100 animate-pulse' : 'bg-blue-50 text-blue-600 border-blue-100'}`}>
          ...
          <div className="p-10 space-y-12">
                ...
                <div className="bg-[#0b1222] rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden h-full">
                  ...
                  <div className="flex items-center justify-between mb-8 relative z-10">
                    <div className="flex items-center gap-4">
                      ...
                      <h4 className="text-sm font-black uppercase tracking-widest">Sales Grading Matrix</h4>
                    </div>
                    {!isReadOnly && (
                      <button 
                      ...
                      <div key={cat.key} className="space-y-2">
                        <div className="flex justify-between items-center">
                           <div className="flex items-center gap-2">
                             ...
                             <span className="text-[10px] font-black uppercase tracking-widest text-slate-300">{cat.label} ({wPct}%)</span>
                           </div>
                ...
                {!isReadOnly ? (
                  <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm h-full flex flex-col min-h-0">
                    <div className="flex flex-col flex-1 min-h-0 gap-4">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 flex-shrink-0">Supervisor Comments</label>
                      <div className="flex-1 min-h-0 flex flex-col">
                        <textarea 
                          ...
                          className="w-full h-full min-h-[140px] bg-slate-50 border border-slate-200 rounded-2xl p-5 text-sm font-medium text-slate-700 outline-none focus:ring-4 focus:ring-blue-500/10 resize-none overflow-auto"
                    ...
                    <div className="grid grid-cols-2 gap-4 flex-shrink-0 pt-2">
                      <button 
                        ...
                        className="py-4 rounded-xl bg-red-50 text-red-600 text-[10px] font-black uppercase tracking-widest hover:bg-red-100 transition-colors"
                      >
                        Recommend: Needs Changes
                      </button>
                      <button 
                        onClick={() => handleAction('APPROVE')}
                        className="py-4 rounded-xl bg-emerald-600 text-white text-[10px] font-black uppercase tracking-widest hover:bg-emerald-700 transition-colors shadow-lg shadow-emerald-200"
                      >
                        Recommend: Approve
                      </button>
                    </div>
            ...
            {selectedItem.projectReport && (
              <div className="space-y-4">
                <div className="flex items-center gap-3"><div className="w-8 h-8 bg-slate-900 rounded-lg flex items-center justify-center"><Megaphone className="w-4 h-4 text-white" /></div><p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Employee Narrative</p></div>
                <div className="bg-blue-50/30 rounded-[2.5rem] p-8 text-sm font-medium text-slate-600 italic border border-blue-50 leading-relaxed">"{selectedItem.projectReport}"</div>
              </div>
            )}
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50/30 rounded-[2.5rem] p-8 text-sm font-medium text-slate-600 italic border border-blue-50 leading-relaxed">"{selectedItem.supervisorComment || (isReadOnly ? 'No supervisor reason saved.' : 'Waiting for admin review.')}"</div>
            </div>
                ...
                {Object.keys(CATEGORY_ICONS).map((category) => {
                  ...
                  const renderTasks = () => {
                    if (!payload || typeof payload !== 'object') {
                      return (
                        <div className="bg-slate-50 p-5 rounded-[1.5rem] border border-slate-100 text-sm text-slate-400 italic">
                    ...
                    return entries
                      .map(([k, v]) => {
                        if (k === 'checklist' && v && typeof v === 'object' && !Array.isArray(v)) {
                          ...
                          return (
                            <div key={k} className="bg-slate-50 p-5 rounded-[1.5rem] border border-slate-100 flex flex-col justify-between gap-3 hover:border-blue-200 transition-colors">
                              <div>
            ...
            {/* Evidence Registry */}
            <div className="space-y-4">
              <div className="flex items-center gap-3"><div className="w-8 h-8 bg-slate-900 rounded-lg flex items-center justify-center"><Paperclip className="w-4 h-4 text-white" /></div><p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Evidence Registry</p></div>
