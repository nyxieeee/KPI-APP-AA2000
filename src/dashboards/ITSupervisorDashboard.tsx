...
const ITSupervisorDashboard: React.FC<Props> = ({ 
        ...
        <div className="bg-slate-100 rounded-xl p-5 border border-slate-200 shadow-sm">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div>
              ...
              <h2 className="mt-1 text-xl font-black text-slate-900 tracking-tight uppercase">IT Performance</h2>
  ...
  return (
    <div className="w-full flex flex-col px-4 sm:px-6 md:px-8 lg:px-8 pb-6 md:pb-12">
      ...
      >
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight leading-none">IT Supervisor</h1>
        </div>
      </div>
