    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-slate-100 rounded-[2.5rem] p-8 border border-slate-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'pending' ? 'text-blue-600/90' : 'text-slate-500'}`}>Accounting Department</p>
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'history' ? 'text-emerald-600/90' : 'text-slate-500'}`}>Accounting Department</p>
            <div className="relative flex items-center justify-center w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgb(226 232 240)" strokeWidth="10" />
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'rejected' ? 'text-red-600/90' : 'text-slate-500'}`}>Accounting Department</p>
            <div className="relative flex items-center justify-center w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgb(226 232 240)" strokeWidth="10" />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-[2rem] border border-slate-100">
        <div className="flex items-center gap-4">
          ...
          <div><h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Accounting Registry</h3><p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{queueTab === 'pending' ? 'Pending Accounting Review' : queueTab === 'history' ? 'Validated Accounting Records' : 'Rejected Accounting Records'}</p></div>
        </div>
        ...
        {searchFilteredQueue.length === 0 ? (
          <div className="py-20 text-center bg-white rounded-[2rem] border border-slate-50 border-dashed">
            ...
            <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">
              {searchTerm.trim() ? 'No records match your search' : 'No Accounting records in this tab'}
            </p>
          </div>
        ) : (
                  ...
                  <div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mt-1">
                      <p className="text-[9px] font-bold uppercase tracking-widest text-slate-400">
                        Submission ID: {item.id} • {item.jobId}
                      </p>
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Accounting Unit Matrix</h3>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Accounting Personnel</th>
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-500">
        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
          <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-6">Accounting Department — Last 30 Days</h3>
          ...
          <div className="p-10 space-y-12">
                ...
                <div className="bg-[#0b1222] rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden h-full">
                  ...
                  <div className="flex items-center justify-between mb-8 relative z-10">
                    <div className="flex items-center gap-4">
                      ...
                      <h4 className="text-sm font-black uppercase tracking-widest">Accounting Grading Matrix</h4>
                    </div>
                    {!isReadOnly && (
                      <button 
              ...
              <div className="lg:col-span-5 flex flex-col gap-6 min-h-0">
                {!isReadOnly ? (
                    ...
                    <div className="flex flex-col flex-1 min-h-0 gap-4">
                      ...
                      <div className="flex-1 min-h-0 flex flex-col">
                        <textarea
                          ...
                          className="w-full h-full min-h-[140px] bg-slate-50 border border-slate-200 rounded-2xl p-5 text-sm font-medium text-slate-700 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 resize-none overflow-auto"
                  ...
                  <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-6 h-full flex flex-col justify-center">
                    ...
                    <button type="button" onClick={() => setCurrentPage('queue')} className="w-full py-5 bg-slate-900 text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all mt-6">Back to Submissions</button>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Employee Narrative</p>
              </div>
              <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Supervisor reason</p>
              </div>
              <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                    ...
                    {fallbackCategories.map((category) => {
                      ...
                      const renderTasks = () => {
                        ...
                        return panels.map((panel) => (
                          <div key={panel.label} className="bg-slate-50 p-5 rounded-[1.5rem] border border-slate-100 flex flex-col justify-between gap-3 hover:border-blue-200 transition-colors">
                            <div>
                              <div className="flex justify-between items-start mb-2">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Supporting documents</p>
              </div>
      ...
      <div className="hidden lg:block">
        <RoleSidenav
          ...
          items={[
            ...
            { id: 'queue', label: 'Submissions', description: pendingCount ? `${pendingCount} to review` : 'Review submissions', icon: ListTodo, badge: pendingCount },
