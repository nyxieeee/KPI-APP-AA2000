          ...
          <div className="p-10 space-y-12">
              ...
              <div className="lg:col-span-5 flex flex-col gap-6 min-h-0">
                {!isReadOnly ? (
                  ...
                  <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-6 h-full flex flex-col justify-center">
                    ...
                    <button type="button" onClick={() => setCurrentPage('queue')} className="w-full py-5 bg-slate-900 text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all mt-6">Return to Registry</button>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Supervisor Justification</p>
              </div>
              <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Global Evidence Registry</p>
              </div>
