...
const TechnicalSupervisorDashboard: React.FC<Props> = ({ 
  ...
  /** Employee submission KPI from `allSalesData` (not supervisor final). Matches employee Technical Registry. */
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-slate-100 rounded-[2.5rem] p-8 border border-slate-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'pending' ? 'text-blue-600/90' : 'text-slate-500'}`}>Technical Department</p>
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'history' ? 'text-emerald-600/90' : 'text-slate-500'}`}>Technical Department</p>
            <div className="relative flex items-center justify-center w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgb(226 232 240)" strokeWidth="10" />
          ...
          >
            ...
            <p className={`text-[9px] font-bold uppercase tracking-widest mb-4 ${queueTab === 'rejected' ? 'text-red-600/90' : 'text-slate-500'}`}>Technical Department</p>
            <div className="relative flex items-center justify-center w-40 h-40">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgb(226 232 240)" strokeWidth="10" />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-[2rem] border border-slate-100">
        <div className="flex items-center gap-4">
          ...
          <div><h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Technical Registry</h3><p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{queueTab === 'pending' ? 'Pending Tech Review' : queueTab === 'history' ? 'Validated Tech Records' : 'Rejected Tech Records'}</p></div>
        </div>
        ...
        {searchFilteredQueue.length === 0 ? (
          <div className="py-20 text-center bg-white rounded-[2rem] border border-slate-50 border-dashed">
            ...
            <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">
              {searchTerm.trim() ? 'No records match your search' : 'No Technical records in this tab'}
            </p>
          </div>
        ) : (
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-[2rem] border border-slate-100">
        <div className="flex items-center gap-4">
          ...
          <div><h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Technical Team Roster</h3><p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Department members and their roles</p></div>
        </div>
        <div className="flex items-center gap-4 md:gap-6">
          <div className="relative group w-full md:w-auto">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 md:w-5 md:h-5 text-slate-300 group-focus-within:text-blue-600 transition-colors" />
      ...
      >
        ...
        {filteredTeam.length === 0 ? (
          ...
          filteredTeam.map((member, idx) => (
            <div key={idx} className={`group flex items-center justify-between p-6 rounded-[2rem] border hover:shadow-md transition-all ${member.isSupervisor ? 'bg-blue-50 border-blue-100' : 'bg-white border-slate-50'}`}>
              <div className="flex items-center gap-6">
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center font-black ${member.isSupervisor ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-600'}`}>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span className="inline-block px-2 py-0.5 rounded-md bg-slate-100 text-slate-500 text-[9px] font-bold uppercase tracking-widest">{member.role}</span>
                  </div>
                </div>
              </div>
            </div>
  ...
  const renderIncentives = () => {
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-500">
        ...
        {/* Personnel Yield Tracking — matches Registry table panel */}
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Technical Personnel</th>
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-500">
        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
          <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-6">Technical Department — Last 30 Days</h3>
                ...
                <div className="bg-[#0b1222] rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden h-full">
                  ...
                  <div className="flex items-center justify-between mb-8 relative z-10">
                    <div className="flex items-center gap-4">
                      ...
                      <h4 className="text-sm font-black uppercase tracking-widest">Technical Grading Matrix</h4>
                    </div>
                    {!isReadOnly && (
                      <button 
                        type="button"
