              ...
              {user.role === UserRole.ADMIN && (
                <div className="pt-4 border-t border-slate-100">
                  <button
                    ...
                    className="w-full py-4 rounded-2xl font-black uppercase text-[11px] tracking-[0.2em] shadow-lg transition-all flex items-center justify-center gap-3 bg-red-50 text-red-700 hover:bg-red-100 border border-red-100"
        ...
        <div className="max-w-[1800px] mx-auto w-full px-4 md:px-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative" ref={bellRef}>
              ...
              {isBellOpen && (
                <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-slate-100 rounded-3xl shadow-2xl shadow-slate-200/60 z-[2000] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
