...
const INITIAL_REGISTRY = [
  ...
  { name: 'paulotecsup', password: 'supervisor', department: 'Technical', role: UserRole.SUPERVISOR, isActive: true },
  { name: 'paulosalesemp', password: '123', department: 'Sales', role: UserRole.EMPLOYEE, isActive: true },
  { name: 'paulosalessup', password: 'supervisor', department: 'Sales', role: UserRole.SUPERVISOR, isActive: true },
  { name: 'paulomaremp', password: '123', department: 'Marketing', role: UserRole.EMPLOYEE, isActive: true },
  { name: 'paulomarsup', password: 'supervisor', department: 'Marketing', role: UserRole.SUPERVISOR, isActive: true },
  { name: 'pauloaccemp', password: '123', department: 'Accounting', role: UserRole.EMPLOYEE, isActive: true },
  { name: 'pauloaccsup', password: 'supervisor', department: 'Accounting', role: UserRole.SUPERVISOR, isActive: true },
  { name: 'employee', password: 'employee', department: 'Technical', role: UserRole.EMPLOYEE, isActive: true },
  { name: 'supervisor', password: 'supervisor', department: 'Technical', role: UserRole.SUPERVISOR, isActive: true },
  { name: 'admin', password: 'admin', department: 'Admin', role: UserRole.ADMIN, isActive: true },
  { name: 'Paulo Almorfe', password: 'admin', department: 'Admin', role: UserRole.ADMIN, isActive: true }
];

const INITIAL_ADMIN_USERS: Record<string, string[]> = {
  'Technical': ['paulotecemp', 'paulotecsup', 'employee', 'supervisor'],
  'Sales': ['paulosalesemp', 'paulosalessup'],
  'Marketing': ['paulomaremp', 'paulomarsup'],
  'Admin': ['Paulo Almorfe', 'admin'],
...
const PREINSTALLED_TECHNICAL_AUDIT = {
  id: 'TX-TEC-SEED1',
  userId: userId('paulotecemp'),
  userName: 'paulotecemp',
...
const App: React.FC = () => {
  ...
  const handleSupervisorGrade = useCallback(
    (
      ...
      const recLabel = supervisorRecommendation === 'approved' ? 'Recommend: Approve' : 'Recommend: Needs Changes';
