export interface IncentiveTier {
  ...
  minScore: number;
  yield: number;
  /** Optional display string for supervisor/employee points cards (e.g. ₱9k - ₱12k). */
  payoutRange?: string;
}

export const DEFAULT_INCENTIVE_TIERS: IncentiveTier[] = [
  { status: 'Top Performer (A- or higher)', outcome: 'Top Tier Eligible', minScore: 90, yield: 100, payoutRange: '₱9k - ₱12k' },
  { status: 'Mid Performer (B- to B+)', outcome: 'Mid Tier Eligible', minScore: 80, yield: 75, payoutRange: '₱6k - ₱8k' },
  { status: 'Base Performer (C to C+)', outcome: 'Base Tier Eligible', minScore: 70, yield: 50, payoutRange: '₱3k - ₱4.5k' },
  { status: 'Coaching Required (D)', outcome: 'Improvement Plan', minScore: 60, yield: 0, payoutRange: '₱0' },
  { status: 'Underperformer (F)', outcome: 'PIP / Review', minScore: 0, yield: 0, payoutRange: '₱0 (PIP)' },
];
...
/** Which tier applies to a final score (same rule as points %). */
...
/** Display line for incentive amount on points UI. */
